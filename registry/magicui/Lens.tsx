 ...
 * Source: https://github.com/magicuidesign/magicui/blob/d7207e5692d14c00dceafa8488d6d01f197fa0e4/apps/www/registry/magicui/lens.tsx
 * Adapted imports for portable React. */
"use client";

import React, { useCallback, useMemo, useRef, useState } from "react";
import { AnimatePresence, motion, useReducedMotion, useMotionTemplate } from "motion/react";
...
export function Lens({
  ...
  const LensContent = useMemo(() => {
    ...
    return (
      <motion.div
        aria-hidden="true"
        initial={reducedMotion ? false : { opacity: 0, scale: 0.58 }}
  ...
  }, [currentPosition, maskImage, zoomFactor, children, duration, reducedMotion]);
