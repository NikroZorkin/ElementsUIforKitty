 ...
 * Source: https://github.com/magicuidesign/magicui/blob/d7207e5692d14c00dceafa8488d6d01f197fa0e4/apps/www/registry/magicui/animated-grid-pattern.tsx
      ...
      <svg x={x} y={y} className="overflow-visible">
        {squares.map(({ pos: [squareX, squareY], id, iteration }, index) => (
          <motion.rect
            ...
            onAnimationComplete={() => {
              if (!reducedMotion) updateSquarePosition(id);
            }}
            key={`${id}-${iteration}`}
            width={width - 1}
            height={height - 1}
