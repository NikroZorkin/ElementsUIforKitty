 ...
 * Source: https://github.com/magicuidesign/magicui/blob/d7207e5692d14c00dceafa8488d6d01f197fa0e4/apps/www/registry/magicui/warp-background.tsx
...
const Beam = ({
  ...
  return (
    <motion.div
      ...
      animate={{ y: reducedMotion ? "30%" : "-100%", x: "-50%" }}
      transition={
        reducedMotion
          ? { duration: 0 }
          : {
