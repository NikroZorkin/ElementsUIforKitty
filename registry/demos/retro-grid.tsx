...
"use client";
import { RetroGrid as Component } from "../magicui/RetroGrid";
export default function Demo() {
  return (
    <>
      <div className="relative flex min-h-[420px] w-full items-center justify-center overflow-hidden bg-background p-8">
        <Component angle={62} cellSize={55} lightLineColor="#a7b8c9" darkLineColor="#516d92" />
        <div className="pointer-events-none relative z-10 max-w-sm text-center">
          ...
          <h2 className="text-4xl font-semibold tracking-tight">The next horizon.</h2>
        </div>
      </div>
    </>
  );
