 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/folder-reveal/index.tsx
...
const FolderReveal = ({
  ...
  return (
    ...
    >
      ...
      <motion.button
        animate={shouldReduceMotion ? { rotateX: 0 } : { rotateX: open ? FLAP_OPEN_ROTATE_X : 0 }}
        aria-expanded={open}
        aria-label={label}
