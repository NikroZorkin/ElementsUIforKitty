 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/blocks/faqs/faq-1/index.tsx
        ...
        <div className="mt-8 md:mt-8">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: INITIAL_Y_OFFSET }}
              key={activeTab}
              transition={
                shouldReduceMotion
                  ? { duration: 0 }
              ...
              <div className="space-y-6">
                <dl className="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
                  {categories[activeTab].faqs.map((faq, faqIndex) => {
                    const IconComponent = iconMap[faq.icon as keyof typeof iconMap] || HelpCircle;
                    ...
                    return (
                      <motion.div
                        ...
                        className="space-y-3"
                        initial={
                          shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: INITIAL_Y_OFFSET }
                        }
