 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/animated-file-upload/index.tsx
          ...
          <AnimatePresence initial={false}>
            {files.map((file, index) => (
              <motion.li
                ...
                initial={shouldReduceMotion ? { opacity: 0 } : { opacity: 0, scale: 0.95, x: -16 }}
