 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/book/index.tsx
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: variant === "simple" ? color : "var(--color-background)",
        ...
        >
          {variant === "stripe" ? (
            <StripeContent illustration={illustration} logo={logo} title={title} width={width} />
          ) : (
        ...
        <div
          ...
          style={{
            backgroundColor: variant === "simple" ? color : "var(--color-background)",
            borderRadius: BOOK_BORDER_RADIUS,
            height: "100%",
