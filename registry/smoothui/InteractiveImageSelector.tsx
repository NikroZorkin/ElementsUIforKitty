 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/interactive-image-selector/index.tsx
      ...
      <div className="absolute top-5 right-5 left-5 z-20 flex justify-between p-4">
        <motion.button
          ...
          className={`cursor-pointer rounded-full px-3 py-1 font-semibold text-sm bg-blend-luminosity backdrop-blur-xl transition-colors ${
            isResetting ? "bg-brand/30 text-white" : "bg-background/20 text-foreground"
          }`}
        ...
        <motion.button
          animate={
            isSelecting
              ? {
                  ...
                  scale: [SELECT_SCALE_START, SELECT_SCALE_PEAK, SELECT_SCALE_END],
                }
              : {}
          }
          ...
          className={`cursor-pointer rounded-full px-3 py-1 font-semibold text-sm bg-blend-luminosity backdrop-blur-xl ${
            isSelecting ? "bg-brand/30 text-white" : "bg-background/20 text-foreground"
          }`}
          exit={{ rotate: 0 }}
          initial={{ rotate: 0 }}
      ...
      <motion.div
        animate={
          shouldReduceMotion || !isResetting
            ? {}
            : {
                scale: [CONTAINER_SCALE_START, CONTAINER_SCALE_MIN, CONTAINER_SCALE_END],
              }
        }
            ...
            <motion.div
              animate={{
                ...
                rotate: isResetting
                  ...
                  : 0,
                scale: isResetting ? [ITEM_SCALE_START, ITEM_SCALE_MIN, ITEM_SCALE_END] : 1,
              }}
      ...
      <AnimatePresence>
        {isSelecting ? (
          <motion.div
            ...
            transition={shouldReduceMotion ? { duration: 0 } : { duration: 0.25 }}
          >
            <button className="cursor-pointer text-brand" onClick={handleShare} type="button">
              <Share2 size={24} />
            </button>
