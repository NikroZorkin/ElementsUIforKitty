 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/scrollable-card-stack/index.tsx
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="font-normal text-foreground/70 text-sm">{item.handle}</span>
                </a>
              </div>
            </motion.div>
          );
          ...
          {Array.from({ length: items.length }, (_, i) => (
            <motion.button
              ...
              className={cn(
                ...
                i === currentIndex ? "scale-125 bg-brand" : "bg-gray-300 hover:bg-gray-400",
              )}
