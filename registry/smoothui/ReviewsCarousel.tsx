 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/reviews-carousel/index.tsx
  ...
  return (
    ...
    >
      <blockquote className="relative">
        ...
        <p className="relative text-foreground/80 text-sm leading-relaxed">{review.body}</p>
      </blockquote>
      <figcaption className="mt-4 flex items-center gap-2 border-foreground/5 border-t pt-4">
        <div className="flex flex-col">
          <span className="font-semibold text-foreground text-xs">{review.author}</span>
              ...
              {filteredReviews.map((review: Review, index: number) => (
                <button
                  ...
                  className={cn(
                    ...
                    index === activeIndex ? "w-8 bg-brand" : "w-2 bg-brand/30 hover:bg-brand/50",
                  )}
                  key={review.id}
                  onClick={() => {
