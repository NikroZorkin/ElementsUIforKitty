 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/ai-context-meter/index.tsx
        ...
        {isOpen && hasBreakdown ? (
          ...
          >
            <ul className="list-none space-y-1">
              {breakdown?.map((item) => (
                <li className="flex items-baseline justify-between gap-3 text-xs" key={item.label}>
