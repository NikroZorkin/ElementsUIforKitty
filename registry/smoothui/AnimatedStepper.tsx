 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/animated-stepper/index.tsx
...
export default function AnimatedStepper({
  ...
  return (
    <div className={cn("flex w-full gap-6", isHorizontal ? "flex-col" : "flex-row", className)}>
      <div
        aria-label="Progress steps"
        aria-orientation={isHorizontal ? "horizontal" : "vertical"}
        className={cn(
          "relative flex",
          isHorizontal ? "flex-row items-center justify-between" : "flex-col items-start gap-2",
        )}
        role="tablist"
      >
          ...
          return (
            ...
            >
              <motion.button
                ...
                type="button"
                whileTap={allowClickNavigation && !shouldReduceMotion ? { scale: 0.9 } : undefined}
              >
                {/* Active ring pulse */}
