 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/expandable-cards/index.tsx
...
export default function ExpandableCards({
  ...
  const selectedCard = controlledSelected === undefined ? internalSelected : controlledSelected;
            ...
            <div className="relative h-full w-[200px]">
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-6 text-white">
                ...
                <div className="relative flex items-center gap-2">
                  <button
                    aria-label={`Read story: ${card.title}`}
