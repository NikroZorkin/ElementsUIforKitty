 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/glow-hover-card/index.tsx
    ...
    >
      ...
      <div className="contents">
        {items.map((item, index) =>
          cloneElement(item.element as ReactElement<Record<string, unknown>>, {
            key: item.id,
      ...
      {!shouldReduceMotion && (
        ...
        >
          {items.map((item, index) => {
            ...
            return cloneElement(glowElement as ReactElement<Record<string, unknown>>, {
              key: item.id,
              ref: (el: HTMLElement | null) => {
