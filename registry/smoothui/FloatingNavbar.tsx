 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/floating-navbar/index.tsx
...
export default function FloatingNavbar({
  ...
  return (
    ...
    >
      {logo ? <div className="flex shrink-0 items-center px-1">{logo}</div> : null}
