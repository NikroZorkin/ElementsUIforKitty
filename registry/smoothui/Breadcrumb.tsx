 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/breadcrumb/index.tsx
        ...
        {items.map((item, index) => {
          ...
          return (
            <motion.li
              ...
              initial={
                shouldReduceMotion ? { opacity: 1 } : { opacity: 0, transform: "translateX(-4px)" }
              }
              key={typeof item.label === "string" ? item.label : `breadcrumb-${String(index)}`}
              transition={
                shouldReduceMotion
                  ? { duration: 0 }
                  : {
            ...
            >
              {index > 0 && (
                <span aria-hidden="true" className="mr-1.5 [&>svg]:size-3.5" role="presentation">
