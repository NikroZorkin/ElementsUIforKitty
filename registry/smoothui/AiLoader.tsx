 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/ai-loader/index.tsx
...
const Elapsed = () => {
  ...
  useAnimationFrame((time) => {
    ...
    setSeconds((current) =>
      next.toFixed(ELAPSED_DECIMALS) === current.toFixed(ELAPSED_DECIMALS) ? current : next,
    );
  });

  return <span className="tabular-nums opacity-60">{seconds.toFixed(ELAPSED_DECIMALS)}s</span>;
};
