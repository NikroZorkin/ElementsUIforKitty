 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/blocks/headers/header-5/index.tsx
    ...
    <section aria-labelledby="hero-spotlight-heading">
      <div className="relative flex min-h-[600px] items-center justify-center overflow-hidden bg-zinc-950 py-24 md:py-32">
        ...
        <motion.div
          ...
          initial={shouldReduceMotion ? { opacity: 0.15 } : { opacity: 0, scaleX: 0 }}
          style={{
            background:
              "conic-gradient(from 180deg at 50% 0%, transparent 40%, rgba(120, 119, 198, 0.12) 50%, transparent 60%)",
          }}
          transition={
            shouldReduceMotion ? { duration: 0 } : { duration: 0.8, ease: [0.23, 1, 0.32, 1] }
          }
          viewport={{ once: true }}
          whileInView={shouldReduceMotion ? { opacity: 0.15 } : { opacity: 0.15, scaleX: 1 }}
        />
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg text-zinc-400">
              Beautifully animated components built with React, Motion, and Tailwind CSS. Open
