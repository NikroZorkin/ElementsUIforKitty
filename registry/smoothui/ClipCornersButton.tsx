...
export function ClipCornersButton({ children, className = "", onClick }: ClipCornersButtonProps) {
  ...
  return (
    ...
    >
      ...
      >
        <svg aria-label="Top-left triangle" className="fill-background" height="8" width="8">
      ...
      >
        <svg aria-label="Top-right triangle" className="fill-background" height="8" width="8">
      ...
      >
        <svg aria-label="Bottom-left triangle" className="fill-background" height="8" width="8">
      ...
      >
        <svg aria-label="Bottom-right triangle" className="fill-background" height="8" width="8">
