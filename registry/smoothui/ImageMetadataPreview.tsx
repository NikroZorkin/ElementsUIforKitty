 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/image-metadata-preview/index.tsx
...
export default function ImageMetadataPreview({
  ...
  return (
    <div className="relative flex w-full max-w-[300px] flex-col items-center justify-center gap-4">
      <motion.div
          ...
          <AnimatePresence>
            {openInfo ? null : (
              <motion.button
                ...
                initial={shouldReduceMotion ? { opacity: 1 } : { filter: "blur(4px)", opacity: 0 }}
                ...
                <table className="flex w-full flex-col items-center gap-4 text-foreground">
                  <tbody className="w-full">
                    <tr className="flex w-full flex-row items-center gap-4">
                      ...
                      <td className="w-1/2 text-muted-foreground">{metadata.created}</td>
                    </tr>
                    <tr className="flex w-full flex-row items-center gap-4">
                      <td className="w-1/2">Updated</td>
                      <td className="w-1/2 text-muted-foreground">{metadata.updated}</td>
                    </tr>
                    <tr className="flex w-full flex-row items-center gap-4">
