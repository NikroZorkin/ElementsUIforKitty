 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/button-copy/index.tsx
...
const defaultIcons = {
  idle: <Copy size={16} />,
  loading: <LoaderCircle className="animate-spin motion-reduce:animate-none" size={16} />,
  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        disabled={buttonState === "loading" || buttonState === "success" || disabled}
        onClick={handleClick}
        type="button"
      >
        <AnimatePresence initial={false} mode="popLayout">
          <motion.span
            animate={
              shouldReduceMotion ? { opacity: 1 } : { filter: "blur(0px)", opacity: 1, y: 0 }
            }
            ...
            initial={
              shouldReduceMotion ? { opacity: 1 } : { filter: "blur(10px)", opacity: 0, y: -25 }
            }
            key={buttonState}
            transition={
              shouldReduceMotion
