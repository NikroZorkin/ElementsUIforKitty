 ...
 * Source: https://github.com/educlopez/smoothui/blob/df0453c967224a91d460aa3bd1786c737c2c95bc/packages/smoothui/components/hover-expand/index.tsx
      ...
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className={cn(isHorizontal && !isActive && "origin-left whitespace-nowrap")}>
                <p className="font-semibold text-sm text-white">{item.title}</p>
                {isActive && item.description ? (
                  <p className="mt-1 text-white/80 text-xs">{item.description}</p>
                ) : null}
              </div>
            </motion.div>
          </motion.button>
